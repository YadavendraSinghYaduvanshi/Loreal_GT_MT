...
public class MaterialCamera {
    ...
    public MaterialCamera filename(@Nullable String filename) {
        fileName = filename;
        return this;
    }
  ...
  */
    ...
    public Intent getIntent() {
        final Class<?> cls =CaptureActivity.class;
        ...
        Intent intent =
                new Intent(mContext, cls)
                        ...
                        .putExtra(CameraIntentKey.FILE_NAME, fileName)
