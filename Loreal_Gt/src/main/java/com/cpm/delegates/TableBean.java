...
public class TableBean {
    ...
    public static String getJCPPrevioustable() {
        return JCPPrevioustable;
    }

    public static void setJCPPrevioustable(String JCPPrevioustable) {
        TableBean.JCPPrevioustable = JCPPrevioustable;
    }

    public static String JCPPrevioustable;
    ...
    public static String getMappingPaidVisibilitytable() {
        return mappingPaidVisibilitytable;
    }

    public static void setMappingPaidVisibilitytable(String mappingPaidVisibilitytable) {
        TableBean.mappingPaidVisibilitytable = mappingPaidVisibilitytable;
    }

    public static String mappingPaidVisibilitytable;
    ...
    public static String getEmpSalarytable() {
        return empSalarytable;
    }

    public static void setEmpSalarytable(String empSalarytable) {
        TableBean.empSalarytable = empSalarytable;
    }

    public static String empSalarytable;
    ...
    public static String getStateMasterTable() {
        return stateMasterTable;
    }

    public static void setStateMasterTable(String stateMasterTable) {
        TableBean.stateMasterTable = stateMasterTable;
    }

    public static String getCityMasterTable() {
        return cityMasterTable;
    }

    public static void setCityMasterTable(String cityMasterTable) {
        TableBean.cityMasterTable = cityMasterTable;
    }

    public static String cityMasterTable;
    public static String stateMasterTable;

    public static String nonworkingtable;

    public static String getWindowNonReasontable() {
        return WindowNonReasontable;
    }

    public static void setWindowNonReasontable(String windowNonReasontable) {
        WindowNonReasontable = windowNonReasontable;
    }

    public static String WindowNonReasontable;

    public static String getNonworkingsubreasontable() {
        return nonworkingsubreasontable;
    }

    public static void setNonworkingsubreasontable(String nonworkingsubreasontable) {
        TableBean.nonworkingsubreasontable = nonworkingsubreasontable;
    }

    public static String nonworkingsubreasontable;
    ...
    public static String promotiontable;

    public static String getPromotiontable() {
        return promotiontable;
    }

    public static void setPromotiontable(String promotiontable) {
        TableBean.promotiontable = promotiontable;
    }

    public static String getDisplayMasterTable() {
        return displayMasterTable;
    }

    public static void setDisplayMasterTable(String displayMasterTable) {
        TableBean.displayMasterTable = displayMasterTable;
    }

    public static String displayMasterTable;

    public static String getNonPromotionReasonTable() {
        return nonPromotionReasonTable;
    }

    public static void setNonPromotionReasonTable(String nonPromotionReasonTable) {
        TableBean.nonPromotionReasonTable = nonPromotionReasonTable;
    }

    public static String nonPromotionReasonTable;

    public static String getNonPosmReasonTable() {
        return nonPosmReasonTable;
    }

    public static void setNonPosmReasonTable(String nonPosmReasonTable) {
        TableBean.nonPosmReasonTable = nonPosmReasonTable;
    }

    public static String nonPosmReasonTable;
